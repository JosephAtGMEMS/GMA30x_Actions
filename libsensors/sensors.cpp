...
static const struct sensor_t sSensorSupportList[] = {   
        ...
        { 
          ...
          (4.0f * GRAVITY_EARTH) / 256.0f,     // -2G ~ +2G, 8 bit
          0.20f, 10, 0, 0, 
          { (void*)"SC7A30" }    // reserved[0] --> input device name
        },
        ...
        { 
          "GMA301 3-axis Accelerometer",
          "GlobalMems",
          1, SENSORS_ACCELERATION_HANDLE,
          SENSOR_TYPE_ACCELEROMETER, 
          (12.0f * GRAVITY_EARTH), 
          (12.0f * GRAVITY_EARTH) / 64.0f,    // -6G ~ +6G, 10 bit
          0.145f, 10, 0, 0, 
          { (void*)"gma301" }    // reserved[0] --> input device name
        },
        { 
          "GMA302 3-axis Accelerometer",
          "GlobalMems",
          1, SENSORS_ACCELERATION_HANDLE,
          SENSOR_TYPE_ACCELEROMETER, 
          (32.0f * GRAVITY_EARTH), 
          (GRAVITY_EARTH) / 1024.0f,    // -16G ~ +16G, 13 bit
          0.145f, 10, 0, 0, 
          { (void*)"gma302" }    // reserved[0] --> input device name
        },	
        { 
          "GMA303 3-axis Accelerometer",
          "GlobalMems",
          1, SENSORS_ACCELERATION_HANDLE,
          SENSOR_TYPE_ACCELEROMETER, 
          (32.0f * GRAVITY_EARTH), 
          (GRAVITY_EARTH) / 1024.0f,    // -16G ~ +16G, 13 bit
          0.145f, 10, 0, 0, 
          { (void*)"gma303" }    // reserved[0] --> input device name
        },		
        { 
