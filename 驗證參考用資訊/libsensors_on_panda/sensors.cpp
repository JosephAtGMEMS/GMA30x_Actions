...
#ifdef SENSORHAL_SUPPORT_JELLYBEAN
		{ 
			...
			(GRAVITY_EARTH * 32.0f),
			(GRAVITY_EARTH * 32.0f)/1024.0f, 
			0.145f, 
			10000, 
			{}
		},
#endif
#ifdef SENSORHAL_SUPPORT_KITKAT
		{ 
			.name = "GMA30x 3-axis Accelerometer",
			.vendor = "GlobalMems Inc.",
			.version = 1, 
			.handle = SENSORS_ACCELERATION_HANDLE,
			.type = SENSOR_TYPE_ACCELEROMETER, 
			.maxRange = (GRAVITY_EARTH * 32.0f),
			.resolution = (GRAVITY_EARTH * 32.0f)/1024.0f, 
			.power = 0.145f, 
			.minDelay = 10000, 
...
struct sensors_module_t HAL_MODULE_INFO_SYM = {
        common: {
                ...
                name: "GlobalMems Sensor Module",
                author: "GlobalMems Inc.",
...
{
#ifdef SENSORHAL_ACC_GMA30x
    mSensors[acc] = new GmaSensor();
#endif
